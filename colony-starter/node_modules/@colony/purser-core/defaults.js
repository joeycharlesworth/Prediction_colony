...
exports.REQUIRED_PROPS = exports.NETWORK_IDS = exports.HTTPS_PROTOCOL = exports.SIGNATURE = exports.TRANSACTION = exports.DESCRIPTORS = exports.GWEI_MINIFICATION = exports.WEI_MINIFICATION = exports.HEX_HASH_TYPE = exports.UNDEFINED = exports.SPLITTER = exports.MATCH = exports.PATH = exports.ENV = void 0;

/*
 * Build environment
 */
var ENV = process && undefined || 'development';
exports.ENV = ENV;
var PATH = {
  /*
...
var HEX_HASH_TYPE = 'hex';
exports.HEX_HASH_TYPE = HEX_HASH_TYPE;
var WEI_MINIFICATION = 1e18;
exports.WEI_MINIFICATION = WEI_MINIFICATION;
var GWEI_MINIFICATION = 1e9;
/*
 * Default class descriptors.
 * Most likely to be used with `Object.defineProperty()`
 */

exports.GWEI_MINIFICATION = GWEI_MINIFICATION;
var DESCRIPTORS = {
  GETTERS: {
    enumerable: true,
    configurable: true
